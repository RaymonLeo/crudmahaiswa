...
<!--   Core JS Files   -->
<script src="<?= base_url('assets/') ?>js/core/sb-admin-2.min.js"></script>
<script>
...
<script>
    function toggleDetails() {
        ...
        if (detailSection.style.display === "none" || detailSection.style.display === "") {
            ...
            arrowIcon.innerHTML = " &#9650;"; // Tanda panah ke atas
        } else {
            detailSection.style.display = "none";
            arrowIcon.innerHTML = " &#9660;"; // Tanda panah ke bawah
        }
    }
...
<script>
    function toggleDetails1() {
        var detailSection = document.getElementById("detail-section1");
    ...
    function scrollToDetails() {
        var element = document.getElementById("detail-section1");
        element.scrollIntoView({
            behavior: "smooth"
        });
    }
...
<script>
    function toggleDetails2() {
        var detailSection = document.getElementById("detail-section2");
    ...
    function scrollToDetails() {
        var element = document.getElementById("detail-section2");
        element.scrollIntoView({
            behavior: "smooth"
        });
    }
